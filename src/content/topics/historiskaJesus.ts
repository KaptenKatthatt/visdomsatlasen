...
export const historiskaJesus: Topic = {
  ...
  min: 4,
  intro:
    'Bakom två tusen år av teologi finns en människa som få samtida sources nämner — och som ändå förändrade världshistorien. Vad kan vi faktiskt veta?',
  essay: [
    [
    ...
    [
      'Hans undervisning kretsade kring det han kallade Guds rike — inte en place utan ett tillstånd där de sista blir de första. Han talade i liknelser som sällan ger färdiga svar, och möttes ofta av frågor med en motfråga. I detta liknar han andra lärare från antiken: ',
  ...
  context: [
    [
      'Galileen var på Jesu tid en romersk lydstat, styrd av Herodes Antipas på kejsarens nåder. Skattetrycket var hårt, avståndet mellan stad och landsbygd växte, och grekiska städer låg en dagsmarsch från arameisktalande byar. Det var en värld där flera language, ekonomier och gudar trängdes på samma marknad.',
    ],
    [
