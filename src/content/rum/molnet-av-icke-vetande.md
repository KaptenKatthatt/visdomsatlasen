---
id: rum-molnet-av-icke-vetande
slug: molnet-av-icke-vetande
titel: Molnet av icke-vetande
...
källor:
  - källa: kalla-molnet-av-icke-vetande
    passage: passage-molnet-kapitel-6
    referens: kapitel 6
    bruk: bearbetning
    primär: true
    redaktionellNot: >-
      Bearbetning av kapitlets tankegång (tanken når inte Gud, kärleken gör
...
redaktion:
  skribent: Claude (utkast, Watts-planen rum 8 / issue #44)
  källgranskare: Claude (förgranskning)
  språkgranskare: Claude (förgranskning)
  granskad: 2026-07-18
  noteringar: >-
    Rum ur docs/research/alan-watts.md avsnitt 6 (rum 8) — byggt helt på den
    fria källan enligt rapportens strategi (fri källtext + egen rumstext).
    Watts pekade mot skriften i sina böcker om mystik kristendom men nämns
    inte i rummet, i linje med rapporten. Källverifiering: kapitel 3 och 6
    lästa i sin helhet i CCEL:s etext av Underhills utgåva (andra utgåvan
    1922, samma text som 1912), ordagrant korsverifierad mot en oberoende
    etext — »of God Himself can no man think«, »He may well be loved, but
    not thought«, »cast down and covered with a cloud of forgetting«, »smite
    upon that thick cloud of unknowing with a sharp dart of longing love«
    (kap. 6) samt molnet mellan människan och Gud och den nakna viljans
    riktning (kap. 3). Nätspärren i byggmiljön gjorde att etexterna nåddes
    via två oberoende speglingar; slutkontroll mot utgåvan vid ägarens
